...
const Sound = {
  ...
  p(f,d,t="sine",v=0.09,dl=0){
    try{const c=this.ctx();if(!c)return;const o=c.createOscillator(),g=c.createGain();
    ...
    o.connect(g);g.connect(c.destination);o.start(c.currentTime+dl);o.stop(c.currentTime+dl+d);}catch(e){}
  },
        ...
        {social==="friends"&&(
          <div>
            ...
            {myFriends.length>0&&(<>
              ...
              {myFriends.map(f=>{const other=f.sender_id===user.id?f.receiver:f.sender;return(
                <Card key={f.id} style={{ marginBottom:"8px",padding:"13px",display:"flex",alignItems:"center",gap:"12px" }}>
